...
print(round(f_smaller,2),round(f_bigger,2),round(f_bigger,2))
print("\n")
...
for i in range(len(countries)):
    ...
    print(percent[i], int(percent[i]), round(percent[i],2), int(round(sumOfPoints * percent[i]/100,0)), countries[i])
